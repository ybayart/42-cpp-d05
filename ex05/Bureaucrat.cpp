...
/*   Updated: 2020/04/28 18:18:05 by hexa             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void
Bureaucrat::executeForm(const Form& src)
{
	try
	{
		src.execute(*this);
		std::cout << this->getName() << " executs " << src.getName() << std::endl;
	}
	catch (std::exception& e)
	{
		std::cout << this->getName() << " can't executs " << src.getName() << " because " << e.what() << std::endl;
	}
}
